const STORAGE_KEY = "football-republic-browser-career-v3";
const LEGACY_STORAGE_KEY = "football-republic-browser-career-v2";
...
const stages = [
  ["governance","政策会议"],["incident","治理危机"],["prep","集训保障"],["release","征调协调"],
  ["mandate","赛前责任"],["arrival","体育场抵达"],["box","主席包厢"],["match","正式比赛"],
  ["post","终场镜头"],["mixed","混合采访"],["review","教练问责"],["between","本轮归档"]
];
const options = {
  prep:{
...
const defaults = {
  version:3,campaign:1,round:0,phase:"governance",selected:null,eventIndex:0,matchEvents:[],pendingResult:null,
  ...
  table:null,matchHistory:[],coachHistory:[],records:[{time:"第1届 · 开幕",text:"主席任期启动：国家队预选赛与国家足球治理议程同时送达办公室。"}],
  governanceCycle:1,governanceCapacity:2,governanceEnactedThisCycle:0,selectedPolicy:null,selectedModel:null,selectedRollout:null,
  activePolicies:{},policyPipeline:[],policyHistory:[],incidentHistory:[],pendingIncident:null,
  ecology:{
    clubSolvency:52,wageSecurity:46,youthPipeline:44,domesticMinutes:48,coachingQuality:47,
    refereeTrust:49,leagueCommerce:56,grassrootsReach:41,womenFootball:36,stadiumSafety:60,
    calendarHealth:51,starRetention:58
  },
  stakeholders:{ministry:61,clubs:54,players:52,localFAs:55,sponsors:58,supporters:57,coaches:53,referees:49}
};
